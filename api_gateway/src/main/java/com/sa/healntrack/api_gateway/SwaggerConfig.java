package com.sa.healntrack.api_gateway;
...
class SwaggerConfig {
    ...
    public void init() {
        ...
        definitions.stream()
                .filter(routeDefinition -> routeDefinition.getId().matches(".*-microservice"))
                .forEach(routeDefinition -> {
                    String name = routeDefinition.getId().replaceAll("-microservice", "");
